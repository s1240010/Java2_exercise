...
class ToyBox<T> {
    ...
    public void add(T t1) {
        v.add(t1);    // Complete add method with proper argument and method body
    }

    public T get(int s) {
        return  v.get(s);   // Complete get method with proper argument and method body
    }
...
public class ToyBoxTest {
    public static void showToysinBox(ToyBox t /* Parameter with bounded wildcard to accept Toy and its subclasses*/) {
        for(int i=0;i<t.getSize();i++)
            System.out.println(t.get(i));                                // Complete showAnimalsinToyBox method with proper argument and method body
    }
    ...
    public static void main(String[] args) {
     ...
     // Create a "toyBox" with proper sentence
      ...
      ToyBox<?extends Toy /* Fill in here with proper wildcard */> sometoyBox = carBox;
